...
#修改主机名
sed -i 's/OpenWrt/Wrouter/g' package/base-files/files/bin/config_generate
#修改型号显示
sed -i 's/Xiaomi Mi Router 4A Gigabit Edition/Wrouter - Xiaomi Mi router 4A Gigabit/g' target/linux/ramips/dts/mt7621_xiaomi_mi-router-4a-gigabit.dts
